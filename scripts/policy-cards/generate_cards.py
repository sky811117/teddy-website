...
POSTS = [
    ...
    },
    {
        ...
        "cover": {
            ...
            "subtitle": "2026/3 鬆+緊雙向調整<br>第二戶 6 成、第三戶 3 成",
        },
        "bullet1": {
            "title": "貸款成數上限",
            "items": [
        ...
        "number": {
            "title": "第二戶換屋族",
            "big": "+360 萬",
            "subtitle": "買 1,800 萬<br>從 8 成貸降到 6 成<br>自備款多生 360 萬",
        },
        "bullet2": {
            "title": "簽約前 3 個必做",
            "items": [
    ...
    },
    {
        ...
        "cover": {
            "title": "預售屋<br>平均地權條例",
            "subtitle": "紅單禁炒、私法人限購<br>檢舉獎金上限 1,000 萬",
        },
        "bullet1": {
            "title": "5 大修法重點",
            "items": [
                "1. 預售屋換約轉售 → 限親屬/非自願",
                "2. 散布不實炒作 → 100-5,000 萬",
                "3. 檢舉獎金 → 罰金 30%、上限 1,000 萬",
                "4. 私法人購屋 → 許可制 5 年不得轉",
                "5. 解約 30 日內申報",
            ],
        },
        "number": {
            "title": "建商協助轉售",
            "big": "50-300 萬",
            "subtitle": "預售屋換約轉售<br>建商協助 / 同意者<br>每戶罰 50-300 萬",
        },
        "bullet2": {
            "title": "3 個合法解約情形",
            "items": [
