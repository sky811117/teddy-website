...
XLSX = OUTPUT_DIR / "policy_posting_plan_v2.xlsx"
...
POSTS = [
    {
        ...
        "caption": (
            ...
            "2026/7/31 新青安 1.0 補貼到期，2.0 版本 6 月底前要拍板。\n"
            "我把所有公開資料、立委質詢、銀行內部風聲整理成一篇 ——\n"
            "你會知道 2.0 可能怎麼變、誰受惠、你該不該等。\n\n"
            "👉 滑完 5 張看完整解讀\n"
            "👉 LINE @sky811117 我用 AI 幫你算 30 年總利息差多少"
        ),
        "hashtags": "#新青安 #新青安2 #首購 #房貸 #台中房地產",
        "pinned_comment": (
            "📌 留言區常見問題：\n"
            "Q1：我超過 40 歲還能用嗎？ → 2.0 可能放寬到 45 歲\n"
            "Q2：第二戶能用新青安嗎？ → 不行，新青安限首購\n"
            "Q3：寬限期會縮嗎？ → 央行希望從 5 年縮到 3 年\n\n"
    ...
    },
    {
        ...
        "date": "5/25（一）21:00",
        "caption": (
            "3 月有個客戶簽約後才發現第二間貸不到 8 成，要多自備 450 萬。\n\n"
            "她聽過央行管制，但以為「只管第三戶以上」。\n"
            "錯了。第七波（2024/9）第二戶就被卡到 5.5 成。\n\n"
            "👉 滑完 5 張你會知道 7 波管制的真實影響\n"
    ...
    },
    {
        ...
        "caption": (
            "3 月新聞 —\n"
            "台中投資客 3 年前買 5 戶預售屋紅單，今年想轉手 ——\n"
            "被檢舉。罰 1,500 萬 + 沒收差價 800 萬。檢舉人領 100 萬。\n\n"
            "他以為「我又沒過戶，只是轉預售合約」。\n"
            "錯了。2023/7/1 平均地權條例修正已經禁了。\n\n"
            "👉 滑完 5 張看 5 大修法重點\n"
        ...
        "pinned_comment": (
            "📌 留言區常見問題：\n"
            "Q1：預售屋買來不住能轉嗎？ → 不能（除親屬 / 非自願 / 同戶換）\n"
            "Q2：公司戶可以買住宅嗎？ → 要申請許可，5 年內不得移轉\n"
            "Q3：紅單轉手會被抓嗎？ → 檢舉獎金 20%，同業都可舉發\n\n"
