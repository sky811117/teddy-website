...
以下是三種常見需求（假設情境，不是實際客戶）：

- 投資型：30 歲、想開始建立資產組合、預算 500 萬
- 首購型：28 歲、想用套房卡位、預算 400 萬
- 第二宅型：50 歲北部移居族、想要台中第二宅、預算 800 萬

把 30 年總成本攤開來算，三種人常見的結論也不一樣：

- 投資型 — 套房報酬率跟金融資產一比，常見的選擇是「部分套房 + 部分金融資產」分散
- 首購型 — 算清 30 年總成本後，常見的選擇是再存 1 年頭期款直接買大樓
- 第二宅型 — 使用頻率高、又想要地段的，七期次新屋小套房是常見選項

**3 種需求、3 種結論**。

套房不是「**萬靈丹**」，要看你的個別需求跟長期計畫。
