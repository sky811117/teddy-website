---
title: FAQ 28:抵押權設定怎麼讀?過戶前一定要確認的 4 個欄位
author: 陳景泰
...
- 買方教學
- 謄本
description: "謄本他項權利部寫著 1200 萬抵押權,不代表屋主欠銀行 1200 萬 — 那是擔保上限,實務上通常是實際借款的 1.2 倍。這篇教你讀懂抵押權設定的 4 個欄位、一般抵押權跟最高限額抵押權差在哪,以及過戶前的塗銷流程怎麼跑。"
...
faqSchema:
  ...
  - '@type': Question
    ...
    acceptedAnswer:
      '@type': Answer
      text: 不一樣。抵押權「擔保債權總金額」是擔保上限,實務上通常是貸款金額的 1.2 倍。例如貸款 1000 萬,抵押權設定 1200 萬。實際欠多少要跟銀行調「貸款餘額證明」才知道。
  - '@type': Question
    name: 抵押權塗銷要多久?
    acceptedAnswer:
      '@type': Answer
...
那 1200 萬是抵押權**擔保上限**,不是實際欠的錢。屋主可能只欠 800 萬,也可能只欠 200 萬,要跟銀行調「貸款餘額證明」才知道。
...
為什麼是 1.2 倍?因為擔保範圍要包含**利息、遲延利息、違約金**等附加費用。萬一債務人違約,銀行除了本金還能就這些一併追償。
...
1. **要求提供「最近 3 個月內的謄本」** —— 別看 1 年前的舊謄本
2. **看清楚他項權利部** —— 抵押權幾筆?是不是最高限額?權利人是銀行還是個人?
3. **請地政士調「貸款餘額證明」** —— 確認實際欠多少
4. **確認「貸款餘額低於成交價」** —— 否則賣掉也還不清,後續容易出狀況

過戶前:

5. **確認塗銷流程同步進行** —— 銀行帳號、塗銷同意書、地政事務所申請
6. **過戶完成後再調一份新謄本** —— 確認他項權利部已經是空的

---

## 試算示範:為什麼謄本一定要看最新的

⚠️ 以下是**假設情境**,用來示範查核的邏輯,不是真實案件,人物與數字都是虛構的。
...
1. 把**謄本拍給我**,我幫你逐欄位讀「他項權利部有幾筆、是不是最高限額、金額合不合理」
2. **過戶前 7 天**,我幫你對一次「塗銷流程是否跟過戶同步進行」 —— 避免過戶後抵押權還掛著
3. **看到權利人是個人而不是銀行** —— 跟我講,我幫你看這筆要怎麼安排處理順序
